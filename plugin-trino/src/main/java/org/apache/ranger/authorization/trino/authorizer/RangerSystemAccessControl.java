...
public class RangerSystemAccessControl
  ...
  public Optional<ViewExpression> getRowFilter(SystemSecurityContext context, CatalogSchemaTableName tableName) {
    ...
    if (isRowFilterEnabled(result)) {
      ...
      // Optional.of(context.getIdentity().getUser()),
  ...
  public void checkCanSetSchemaAuthorization(SystemSecurityContext context, CatalogSchemaName schema,
    ...
    if (!hasPermission(createResource(schema.getCatalogName(), schema.getSchemaName()), context.getIdentity(),
  ...
  private RangerTrinoAccessRequest createAccessRequest(RangerTrinoResource resource, Identity identity,
